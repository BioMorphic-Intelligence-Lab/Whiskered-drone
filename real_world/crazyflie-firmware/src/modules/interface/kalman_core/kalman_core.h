...
static const float COEF_A = 2.654855f;
static const float COEF_B = 0.0509896f;
static const float COEF_C = 0.0126749f;
static const float COEF_D = 0.00142039f;
static const float COEF_EPOLY = 5.84525e-5f;

static const float EPS_force = 1e-6f;
...
/*  - Transfer bodyvelocity to world*/
void kalmanCoreDroneToWorld(const kalmanCoreData_t* coreData_body, kalmanCoreData_t* coreData_world);
