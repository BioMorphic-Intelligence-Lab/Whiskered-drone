...
if __name__ == '__main__':
    ...
    with SyncCrazyflie(URI, cf=cf) as scf:
        ...
        keep_flying = True
        # Max and min depth threshold for FSM, max speed, and rotation rate
        set_initial_params(scf.cf, 50.0, 90.0, 50.0, 90.0, 0.2, 25.0)
        # post linear calibration, now is non-post calibration
